...
Note: Instead of manually building, you can also use our convenient Python script. It allows you to build several binaries in one go and specify options in a simpler way (I would like to use the python script(updating it as required).
...
Finally, send us the feather files generated by the parse script.
